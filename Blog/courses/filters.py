...
class CoursesFilter(django_filters.FilterSet):
    ...
    search = CharFilter(field_name='search', lookup_expr='icontains', widget=forms.TextInput(attrs={'class':'form-control','placeholder':"Search series",'id':'courses-search-input'}))
    class Meta:
        model = Courses
        fields = ['search']
...
class ArticlesFilter(django_filters.FilterSet):
    ...
    search = CharFilter(field_name='search', lookup_expr='icontains', widget=forms.TextInput(attrs={'class':'form-control','placeholder':"Αναζήτηση άρθρων",'id':'articles-search-input'}))
    class Meta:
        model = Articles
        fields = ['search']
